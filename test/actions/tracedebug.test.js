...
const action = require('../../actions/tracedebug/index.js')
...
const fakeParams = { __ow_headers: { authorization: 'Bearer fake' }, id: 'fakeID' }
describe('tracedebug', () => {
  ...
  test('missing input request parameters, should return 400', async () => {
    ...
    expect(response).toEqual({
      error: {
        statusCode: 400,
        body: { error: 'missing header(s) \'authorization\' and missing parameter(s) \'id\'' }
      }
    })
  })
})
